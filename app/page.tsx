        ...
        <section className="py-8 border-y border-gray-100" aria-labelledby="trusted-sources">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-center justify-items-center">
            ...
            <div className="grayscale opacity-60 hover:opacity-100 transition-opacity">
              <svg className="h-8" viewBox="0 0 85 25" fill="currentColor">
                <path d="M21.5 0C9.6 0 0 9.6 0 21.5S9.6 43 21.5 43 43 33.4 43 21.5 33.4 0 21.5 0zm10.2 23.3c-.3.3-.7.4-1.1.4-.4 0-.8-.1-1.1-.4L21.5 15l-8 8.3c-.3.3-.7.4-1.1.4-.4 0-.8-.1-1.1-.4-.6-.6-.6-1.5 0-2.1l9.1-9.4c.6-.6 1.5-.6 2.1 0l9.1 9.4c.6.6.6 1.6.1 2.1zm51.8-8.2c0-1.8-1.5-3.3-3.3-3.3-1.8 0-3.3 1.5-3.3 3.3 0 1.8 1.5 3.3 3.3 3.3 1.8 0 3.3-1.5 3.3-3.3zm-10.6 0c0-1.8-1.5-3.3-3.3-3.3-1.8 0-3.3 1.5-3.3 3.3 0 1.8 1.5 3.3 3.3 3.3 1.8 0 3.3-1.5 3.3-3.3z"/>
              </svg>
            ...
            <div className="grayscale opacity-60 hover:opacity-100 transition-opacity">
              <svg className="h-6" viewBox="0 0 200 30" fill="currentColor">
                <path d="M27.7 0L0 15.5v3l27.7 15.4 27.7-15.4v-3L27.7 0zm-2 26.3l-19.4-11V18l19.4 11v-2.7zm0-5.4L6.3 9.8v2.7l19.4 11v-2.6zm21.4-11.1L27.7 21V7.9l19.4-11v12.9zM73 8.1h3.4v17.7H73V8.1zm17.1 0h3.4v17.7h-3.4V8.1zm17.2 0h3.4v17.7h-3.4V8.1zm17.1 0h3.4v17.7h-3.4V8.1zm17.2 0h3.4v17.7h-3.4V8.1zm17.1 0h3.4v17.7h-3.4V8.1z"/>
              </svg>
              <span className="sr-only">Wirecutter</span>
            </div>
            {/* Consumer Reports */}
            <div className="grayscale opacity-60 hover:opacity-100 transition-opacity">
              <svg className="h-8" viewBox="0 0 200 40" fill="currentColor">
                <path d="M20 0C9 0 0 9 0 20s9 20 20 20 20-9 20-20S31 0 20 0zm0 36c-8.8 0-16-7.2-16-16S11.2 4 20 4s16 7.2 16 16-7.2 16-16 16zm44.3-20.5c-2.3 0-4.1 1.8-4.1 4.1s1.8 4.1 4.1 4.1 4.1-1.8 4.1-4.1-1.9-4.1-4.1-4.1zm35.4 0c-2.3 0-4.1 1.8-4.1 4.1s1.8 4.1 4.1 4.1 4.1-1.8 4.1-4.1-1.8-4.1-4.1-4.1zm35.4 0c-2.3 0-4.1 1.8-4.1 4.1s1.8 4.1 4.1 4.1 4.1-1.8 4.1-4.1-1.8-4.1-4.1-4.1z"/>
              </svg>
